...
import { getFiscalYear, getFiscalQuarter, getFiscalMonth, getStartDate, getEndDate } from "./fiscalYear";
/**
 ...
 */
function getSamePeriodLastYear(date, periodType = "day", timezone = null, startOfWeek = START_OF_WEEK.monday.value, fyStartMonth = DEFAULT_FY_START_MONTH, fyStartDay = DEFAULT_FY_START_DAY) {
