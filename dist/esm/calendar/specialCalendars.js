...
import { getStartDate, getEndDate } from "./fiscalYear";
/**
 ...
 */
function getRetailCalendarOptions(startOfWeek = START_OF_WEEK.monday.value, timezone = null, year = null, calendarSystem = CALENDAR_SYSTEMS.RETAIL_445, fyStartMonth = DEFAULT_FY_START_MONTH, fyStartDay = DEFAULT_FY_START_DAY) {
 ...
 */
function getBiWeeklyOptions(startOfWeek = START_OF_WEEK.monday.value, timezone = null, year = null, fyStartMonth = DEFAULT_FY_START_MONTH, fyStartDay = DEFAULT_FY_START_DAY) {
    const startDate = getStartDate(timezone, year, startOfWeek, fyStartMonth, fyStartDay);
    const endDate = getEndDate(timezone, year, startOfWeek, fyStartMonth, fyStartDay);
 ...
 */
function getSemiMonthlyOptions(timezone = null, year = null, fyStartMonth = DEFAULT_FY_START_MONTH, fyStartDay = DEFAULT_FY_START_DAY) {
