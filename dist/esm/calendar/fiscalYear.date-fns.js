 ...
 */
import { addDays, addMonths, differenceInDays, differenceInMonths, getDate, getMonth, getYear, setDate, setMonth, setYear, startOfWeek, endOfWeek, endOfMonth, format } from 'date-fns';
import { DEFAULT_FY_START_MONTH, DEFAULT_FY_START_DAY, START_OF_WEEK, CALENDAR_SYSTEMS } from "../utils/constants";
import { toDateObject, createDate, cloneDate, subtractTime } from "../utils/dateUtils";
/**
 ...
 */
function getFiscalYear(date, timezone = null, fyStartMonth = DEFAULT_FY_START_MONTH, fyStartDay = DEFAULT_FY_START_DAY) {
 ...
 */
function getCurrentWeekDate(timezone = null, year = null, weekStartDay = null, fyStartMonth = DEFAULT_FY_START_MONTH, fyStartDay = DEFAULT_FY_START_DAY) {
    ...
    const dow = getDayOfWeek(weekStartDay || START_OF_WEEK.monday.value);
 ...
 */
function getStartDate(timezone = null, year = null, weekStartDay = null, fyStartMonth = DEFAULT_FY_START_MONTH, fyStartDay = DEFAULT_FY_START_DAY) {
 ...
 */
function getEndDate(timezone = null, year = null, weekStartDay = null, fyStartMonth = DEFAULT_FY_START_MONTH, fyStartDay = DEFAULT_FY_START_DAY) {
    let currentTime = createDate(undefined, timezone || undefined);
    if (year) {
        currentTime = setYear(currentTime, year);
    }
 ...
 */
function getWeekOptions(weekStartDay = START_OF_WEEK.monday.value, timezone = null, year = null, fyStartMonth = DEFAULT_FY_START_MONTH, fyStartDay = DEFAULT_FY_START_DAY, calendarSystem = CALENDAR_SYSTEMS.STANDARD) {
 ...
 */
function getQuarterOptions(weekStartDay = START_OF_WEEK.monday.value, timezone = null, year = null, fyStartMonth = DEFAULT_FY_START_MONTH, fyStartDay = DEFAULT_FY_START_DAY, calendarSystem = CALENDAR_SYSTEMS.STANDARD) {
    const startDateObj = getStartDate(timezone, year, weekStartDay, fyStartMonth, fyStartDay);
    const quarters = [];
    for (let i = 0; i < 4; i++) {
 ...
 */
function getMonthOptions(weekStartDay = START_OF_WEEK.monday.value, timezone = null, year = null, fyStartMonth = DEFAULT_FY_START_MONTH, fyStartDay = DEFAULT_FY_START_DAY, calendarSystem = CALENDAR_SYSTEMS.STANDARD) {
    const startDateObj = getStartDate(timezone, year, weekStartDay, fyStartMonth, fyStartDay);
    const months = [];
    for (let i = 0; i < 12; i++) {
 ...
 */
function getDateNumber(date, timezone = null, weekStartDay = START_OF_WEEK.monday.value, fyStartMonth = DEFAULT_FY_START_MONTH, fyStartDay = DEFAULT_FY_START_DAY) {
    const dateObj = toDateObject(date, timezone || undefined);
 ...
 */
function getFiscalQuarter(date, timezone = null, weekStartDay = START_OF_WEEK.monday.value, fyStartMonth = DEFAULT_FY_START_MONTH, fyStartDay = DEFAULT_FY_START_DAY) {
    const dateObj = toDateObject(date, timezone || undefined);
    const fiscalYear = getFiscalYear(dateObj, timezone, fyStartMonth, fyStartDay);
    const startDateObj = getStartDate(timezone, fiscalYear, weekStartDay, fyStartMonth, fyStartDay);
 ...
 */
function getFiscalMonth(date, timezone = null, weekStartDay = START_OF_WEEK.monday.value, fyStartMonth = DEFAULT_FY_START_MONTH, fyStartDay = DEFAULT_FY_START_DAY) {
    const dateObj = toDateObject(date, timezone || undefined);
    const fiscalYear = getFiscalYear(dateObj, timezone, fyStartMonth, fyStartDay);
    const startDateObj = getStartDate(timezone, fiscalYear, weekStartDay, fyStartMonth, fyStartDay);
    const monthDiff = differenceInMonths(dateObj, startDateObj);
