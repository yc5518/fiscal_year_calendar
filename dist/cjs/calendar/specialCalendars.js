...
exports.getRetailCalendarOptions = getRetailCalendarOptions;
exports.getBiWeeklyOptions = getBiWeeklyOptions;
exports.getSemiMonthlyOptions = getSemiMonthlyOptions;
 ...
 */
function getRetailCalendarOptions(startOfWeek = constants_1.START_OF_WEEK.monday.value, timezone = null, year = null, calendarSystem = constants_1.CALENDAR_SYSTEMS.RETAIL_445, fyStartMonth = constants_1.DEFAULT_FY_START_MONTH, fyStartDay = constants_1.DEFAULT_FY_START_DAY) {
    const startDate = (0, fiscalYear_1.getStartDate)(timezone, year, startOfWeek, fyStartMonth, fyStartDay);
    const endDate = (0, fiscalYear_1.getEndDate)(timezone, year, startOfWeek, fyStartMonth, fyStartDay);
    const periods = [];
    let currentDate = startDate.clone();
    let periodNumber = 1;
    // Determine the pattern of weeks in each period based on the calendar system
    const getWeeksInPeriod = (periodIndex) => {
        const quarterIndex = Math.floor((periodIndex - 1) / 3);
        const periodInQuarter = (periodIndex - 1) % 3;
        switch (calendarSystem) {
            case constants_1.CALENDAR_SYSTEMS.RETAIL_445:
                return periodInQuarter === 0 || periodInQuarter === 1 ? 4 : 5;
            case constants_1.CALENDAR_SYSTEMS.RETAIL_454:
                return periodInQuarter === 0 || periodInQuarter === 2 ? 4 : 5;
            case constants_1.CALENDAR_SYSTEMS.RETAIL_544:
 ...
 */
function getBiWeeklyOptions(startOfWeek = constants_1.START_OF_WEEK.monday.value, timezone = null, year = null, fyStartMonth = constants_1.DEFAULT_FY_START_MONTH, fyStartDay = constants_1.DEFAULT_FY_START_DAY) {
    const startDate = (0, fiscalYear_1.getStartDate)(timezone, year, startOfWeek, fyStartMonth, fyStartDay);
    const endDate = (0, fiscalYear_1.getEndDate)(timezone, year, startOfWeek, fyStartMonth, fyStartDay);
 ...
 */
function getSemiMonthlyOptions(timezone = null, year = null, fyStartMonth = constants_1.DEFAULT_FY_START_MONTH, fyStartDay = constants_1.DEFAULT_FY_START_DAY) {
    const startDate = (0, fiscalYear_1.getStartDate)(timezone, year, null, fyStartMonth, fyStartDay);
    const endDate = (0, fiscalYear_1.getEndDate)(timezone, year, null, fyStartMonth, fyStartDay);
