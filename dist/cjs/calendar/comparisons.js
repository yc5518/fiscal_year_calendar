...
exports.getSamePeriodLastYear = getSamePeriodLastYear;
exports.compareFiscalPeriods = compareFiscalPeriods;
exports.getYearOverYearChange = getYearOverYearChange;
/**
 ...
 */
function getSamePeriodLastYear(date, periodType = "day", timezone = null, startOfWeek = constants_1.START_OF_WEEK.monday.value, fyStartMonth = constants_1.DEFAULT_FY_START_MONTH, fyStartDay = constants_1.DEFAULT_FY_START_DAY) {
    ...
    const prevFyStartDate = (0, fiscalYear_1.getStartDate)(timezone, previousFiscalYear, startOfWeek, fyStartMonth, fyStartDay);
    ...
    switch (periodType) {
        ...
        case "year":
            ...
            currentPeriodEnd = (0, fiscalYear_1.getEndDate)(timezone, fiscalYear, startOfWeek, fyStartMonth, fyStartDay);
            previousPeriodStart = prevFyStartDate.clone();
            previousPeriodEnd = (0, fiscalYear_1.getEndDate)(timezone, previousFiscalYear, startOfWeek, fyStartMonth, fyStartDay);
            break;
        case "biweekly":
 ...
 */
function compareFiscalPeriods(period1, period2) {
 ...
 */
function getYearOverYearChange(currentValue, previousValue, currentPeriod = "Current Period", previousPeriod = "Previous Period") {
