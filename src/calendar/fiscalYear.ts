 ...
 */
function getTimezone(timezone?: string): moment.Moment {
 ...
 */
function selectOptionStructureWithLabel(
    value: string | number,
    start: moment.Moment,
    end: moment.Moment
): WeekOption {
...
function buildWeekOptions(
    ...
    return weeks.map((value) => {
        ...
        return selectOptionStructureWithLabel(
            String(value),
            currentWeek.startOf("week").clone(),
            currentWeek.endOf("week").clone(),
        );
    });
}
...
export {
    getDayOfWeek,
    calFiscalYear as getFiscalYear,
    getCurrentWeekMoment,
    getTimezone,
    calStartDate as getStartDate,
    calEndDate as getEndDate,
    buildWeekOptions as getWeekOptions,
    buildQuarterOptions as getQuarterOptions,
    buildMonthOptions as getMonthOptions,
    calDateNum as getDateNumber,
    calFiscalQuarter as getFiscalQuarter,
    calFiscalMonth as getFiscalMonth,
};
